...
if __name__ == '__main__':
    ...
    parser.add_argument('remote_repo_url', nargs='?', default="https://github.com/helloworlder8/transformers.git", help="The URL of the remote Git repository. Default is 'https://github.com/helloworlder8/transformers.git'")
    parser.add_argument('push_message', nargs='?', help="The commit message. If not provided, the current date will be used.")
...
# git push -u origin 25-01-04
# git config --global --unset http.proxy
# git config --global --unset http.proxy
#helloworlder8
#ghp_3evWUSgNgYio9UWL4H0C6yxqgrU33x4FUlww

# git config --global http.proxy 127.0.0.1:443
# git config --global https.proxy 127.0.0.1::443
