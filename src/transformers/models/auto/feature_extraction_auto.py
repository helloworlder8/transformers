...
class AutoFeatureExtractor:
    ...
    def __init__(self):
        raise EnvironmentError(
            ...
            "using the `AutoFeatureExtractor.from_pretrained(model_name_or_path)` method."
        )
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        ...
        if has_remote_code and trust_remote_code:
            feature_extractor_class = get_class_from_dynamic_module(
                feature_extractor_auto_map, model_name_or_path, **kwargs
            )
        ...
        raise ValueError(
            f"Unrecognized feature extractor in {model_name_or_path}. Should have a "
