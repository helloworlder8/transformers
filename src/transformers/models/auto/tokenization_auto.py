...
def get_tokenizer_config(
    ...
    **kwargs,
    ...
    resolved_config_file = cached_file( #->'Qwen-1_8B-Chat/tokenizer_config.json'
...
class AutoTokenizer:
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *inputs, **kwargs):
        ...
        use_fast = kwargs.pop("use_fast", True) #默认配置
        ...
        tokenizer_config = get_tokenizer_config(pretrained_model_name_or_path, **kwargs) #tokenizer配置字典
