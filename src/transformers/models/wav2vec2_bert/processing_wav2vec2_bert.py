...
class Wav2Vec2BertProcessor(ProcessorMixin):
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        try:
            ...
            feature_extractor = SeamlessM4TFeatureExtractor.from_pretrained(model_name_or_path, **kwargs)
            tokenizer = Wav2Vec2CTCTokenizer.from_pretrained(model_name_or_path, **kwargs)
