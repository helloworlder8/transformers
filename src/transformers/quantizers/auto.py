...
class AutoQuantizationConfig:
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        ...
        if getattr(model_config, "quantization_config", None) is None:
            raise ValueError(
                f"Did not found a `quantization_config` in {model_name_or_path}. Make sure that the model is correctly quantized."
            )
...
class AutoHfQuantizer:
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path, **kwargs):
        quantization_config = AutoQuantizationConfig.from_pretrained(model_name_or_path, **kwargs)
