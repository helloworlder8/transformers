...
try:
    ...
    _import_structure["models.EASam"].extend(["EASamImageProcessor"])
...
try:
    ...
    # 导入模型
    _import_structure["models.sa2va_chat"].extend(
        [
            "InternVisionModel",
...
if TYPE_CHECKING:
    ...
    # 导入配置
    from .models.sa2va_chat import Sa2VAChatConfig
    ...
    try:
        ...
        from .models.EASam import EASamImageProcessor
    ...
    try:
        ...
        # 导入模型
        from .models.sa2va_chat import Sa2VAChatModel
