...
class ImageProcessingMixin(PushToHubMixin):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        kwargs["cache_dir"] = cache_dir #缓存路径 none
        kwargs["force_download"] = force_download #强制下载 false
        kwargs["local_files_only"] = local_files_only #只要本地文件 false
        kwargs["revision"] = revision #修订版本 'main'
    ...
    def get_image_processor_dict(
        ...
        local_files_only = cls._handle_offline_mode(local_files_only) #False
        ...
        ) #'Ang/EASam/preprocessor_config.json'  True

        # Step 4: Load the image processor dictionary
        image_processor_dict = cls._load_image_processor_dict(resolved_image_processor_file, is_local) #加载成字典
