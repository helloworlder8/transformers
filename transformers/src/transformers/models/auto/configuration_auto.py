...
class AutoConfig:
    ...
    def __init__(self):
        raise EnvironmentError(
            ...
            "using the `AutoConfig.from_pretrained(model_name_or_path)` method."
        )
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        ...
        is loaded, or when it's missing, by falling back to using pattern matching on `model_name_or_path`:
        ...
        if has_remote_code and trust_remote_code:
            ...
            config_class = get_class_from_dynamic_module(
                class_ref, model_name_or_path, code_revision=code_revision, **kwargs
            )
            if os.path.isdir(model_name_or_path):
                config_class.register_for_auto_class()
            return config_class.from_pretrained(model_name_or_path, **kwargs)
        ...
        raise ValueError(
            f"Unrecognized model in {model_name_or_path}. "
