...
class TFBertTokenizer(keras.layers.Layer):
    ...
    @classmethod
    def from_pretrained(cls, model_name_or_path: Union[str, os.PathLike], *init_inputs, **kwargs):
        """
        ...
        """
        try:
            tokenizer = BertTokenizer.from_pretrained(model_name_or_path, *init_inputs, **kwargs)
        except:  # noqa: E722
            from .tokenization_bert_fast import BertTokenizerFast

            tokenizer = BertTokenizerFast.from_pretrained(model_name_or_path, *init_inputs, **kwargs)
