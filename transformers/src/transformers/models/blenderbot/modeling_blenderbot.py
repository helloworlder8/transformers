...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def from_pretrained(cls, model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        if model_name_or_path == "facebook/blenderbot-90M":
            warnings.warn(
            ...
            return BlenderbotSmallModel.from_pretrained(model_name_or_path)

        return super(BlenderbotModel, cls).from_pretrained(model_name_or_path, *model_args, **kwargs)
...
class BlenderbotForConditionalGeneration(BlenderbotPreTrainedModel, GenerationMixin):
    ...
    def from_pretrained(cls, model_name_or_path: Optional[Union[str, os.PathLike]], *model_args, **kwargs):
        if model_name_or_path == "facebook/blenderbot-90M":
            ...
            return BlenderbotSmallForConditionalGeneration.from_pretrained(model_name_or_path)
