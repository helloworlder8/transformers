...
class CLIPProcessor(ProcessorMixin):
    ...
    def __call__(self, text=None, images=None, return_tensors=None, **kwargs):
        ...
        image_features = self.image_processor(images, return_tensors=return_tensors, **image_processor_kwargs) if images else None

        if text and images:
            encoding["pixel_values"] = image_features.pixel_values
            return encoding
        return encoding if text else BatchEncoding(data=dict(**image_features), tensor_type=return_tensors)
