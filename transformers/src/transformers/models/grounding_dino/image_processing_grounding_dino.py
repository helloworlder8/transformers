    ...
    def preprocess(
        ...
        **kwargs,
        ...
        def initialize_parameters():
            nonlocal do_resize, size, resample, do_rescale, rescale_factor, do_normalize
            nonlocal image_mean, image_std, do_convert_annotations, do_pad, pad_size, format
        ...
        def prepare_images_and_annotations():
            nonlocal images, annotations, input_data_format
        ...
        def apply_transformations():
                ...
                if annotations is not None:
                    ...
                    for image, target in zip(images, annotations):
                        ...
                        resized_image = self.resize(
                            image, size=size, max_size=None, resample=resample, input_data_format=input_data_format
                        )
            ...
            # Normalize annotations if required
