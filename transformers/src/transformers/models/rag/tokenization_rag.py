...
class RagTokenizer:
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        ...
        if config is None:
            config = RagConfig.from_pretrained(model_name_or_path)

        question_encoder = AutoTokenizer.from_pretrained(
            model_name_or_path, config=config.question_encoder, subfolder="question_encoder_tokenizer"
        )
        generator = AutoTokenizer.from_pretrained(
            model_name_or_path, config=config.generator, subfolder="generator_tokenizer"
        )
