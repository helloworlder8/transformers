...
class InternLM2ForCausalLM(InternLM2PreTrainedModel): #修改来自llama语言模型
...
class InternLM2ForSequenceClassification(InternLM2PreTrainedModel): #没用到
    def __init__(self, config):
        super().__init__(config)
...
__all__ = ["InternLM2ForCausalLM","InternLM2PreTrainedModel"]
