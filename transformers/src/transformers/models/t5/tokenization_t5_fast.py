...
class T5TokenizerFast(PreTrainedTokenizerFast):
    ...
    def _eventually_correct_t5_max_length(model_name_or_path, max_model_length, init_max_model_length):
        if model_name_or_path in T5TokenizerFast.max_model_input_sizes:
            deprecated_max_model_length = T5TokenizerFast.max_model_input_sizes[model_name_or_path]
            if init_max_model_length is not None and init_max_model_length != max_model_length:
                ...
                warnings.warn(
                    ...
                    f" {model_name_or_path} automatically truncating your input to"
