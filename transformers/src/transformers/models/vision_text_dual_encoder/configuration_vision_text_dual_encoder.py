...
class VisionTextDualEncoderConfig(PretrainedConfig):
    ...
    def __init__(self, projection_dim=512, logit_scale_init_value=2.6592, **kwargs):
        ...
        vision_config = kwargs.pop("vision_config") #dict
        text_config = kwargs.pop("text_config") #dict

        vision_model_type = vision_config.pop("model_type") #'clip_vision_model'
        text_model_type = text_config.pop("model_type") #'roberta'

        vision_config_class = VISION_MODEL_CONFIGS.get(vision_model_type)
        if vision_config_class is not None:
            self.vision_config = vision_config_class(**vision_config) #视觉配置类
        else:
        ...
        self.projection_dim = projection_dim #512
        self.logit_scale_init_value = logit_scale_init_value #2.6592
