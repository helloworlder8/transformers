...
class VisionTextDualEncoderModel(PreTrainedModel):
    ...
    def from_vision_text_pretrained(
        ...
        **kwargs,
        ...
        vision_model = kwargs_vision.pop("model", None) #none
        if vision_model is None:
            ...
            if "config" not in kwargs_vision:
                vision_config = AutoConfig.from_pretrained(vision_model_name_or_path) #取出视觉配置
            ...
            if vision_config.model_type == "clip":
                ...
                kwargs_vision["config"] = vision_config #整体配置
                vision_model = AutoModel.from_pretrained(vision_model_name_or_path, *model_args, **kwargs_vision) #视觉模型
