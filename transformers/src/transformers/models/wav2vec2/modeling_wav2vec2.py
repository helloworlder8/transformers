...
class Wav2Vec2PreTrainedModel(PreTrainedModel):
    ...
    def _get_feat_extract_output_lengths(
        ...
        add_adapter = self.config.add_adapter if add_adapter is None else add_adapter #False
        ...
        for kernel_size, stride in zip(self.config.conv_kernel, self.config.conv_stride):
            input_lengths = _conv_out_length(input_lengths, kernel_size, stride) #torch.Size([]) tensor(292)
