...
class Wav2Vec2ProcessorWithLM(ProcessorMixin):
    ...
    def from_pretrained(cls, model_name_or_path, **kwargs):
        ...
        feature_extractor, tokenizer = super()._get_arguments_from_pretrained(model_name_or_path, **kwargs)
        ...
        if os.path.isdir(model_name_or_path) or os.path.isfile(model_name_or_path):
            ...
            decoder = BeamSearchDecoderCTC.load_from_dir(model_name_or_path, unigram_encoding)
        else:
            ...
            decoder = BeamSearchDecoderCTC.load_from_hf_hub(
                model_name_or_path, allow_patterns=allow_patterns, **kwargs
            )
