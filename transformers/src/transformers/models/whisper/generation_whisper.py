...
class WhisperGenerationMixin(GenerationMixin):
    ...
    def generate(
        ...
        **kwargs,
        ...
        input_stride = self.model.encoder.conv1.stride[0] * self.model.encoder.conv2.stride[0] # 1,2 ->2
        num_segment_frames = input_stride * self.config.max_source_positions #->3000
        ...
        timestamp_begin = self._set_return_timestamps( #->50364
        ...
        logits_processor = self._retrieve_logit_processors(
            generation_config=generation_config,
            logits_processor=logits_processor, #none
            begin_index=begin_index,  # 4
            num_beams=kwargs.get("num_beams", 1), #1
        ...
        max_frames, seek = self._retrieve_max_frames_and_seek(
            ...
            total_input_frames=total_input_frames, #3000
            is_shortform=is_shortform, #True
        )
