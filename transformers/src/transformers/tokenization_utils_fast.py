...
class PreTrainedTokenizerFast(PreTrainedTokenizerBase):
    ...
    def set_truncation_and_padding(
        ...
        """
        Configure truncation and padding strategies for fast tokenizers.

        Args:
            padding_strategy: The padding strategy to apply.
            truncation_strategy: The truncation strategy to apply.
            max_length: The maximum sequence length.
            stride: The stride for overflow handling.
            pad_to_multiple_of: If set, pad sequences to a multiple of this value.
            padding_side: Direction of padding ('left' or 'right').
        """
        truncation_config = {
        ...
        # Apply truncation settings if needed
        if truncation_strategy == TruncationStrategy.DO_NOT_TRUNCATE:
            self._tokenizer.no_truncation()
        elif self._tokenizer.truncation != truncation_config:
            self._tokenizer.enable_truncation(**truncation_config)
        ...
        # Apply padding settings if needed
        if padding_strategy == PaddingStrategy.DO_NOT_PAD:
            self._tokenizer.no_padding()
        elif self._tokenizer.padding != padding_config:
    ...
    def _encode_plus(
        ...
        **kwargs,
        ...
        batched_output = self._batch_encode_plus(
            ...
            add_special_tokens=add_special_tokens,
            padding_strategy=padding_strategy, #<PaddingStrategy.LONGEST: 'longest'>
            truncation_strategy=truncation_strategy, #<TruncationStrategy.DO_NOT_TRUNCATE: 'do_not_truncate'>
    ...
    def _decode(
        ...
        **kwargs,
        ...
        if isinstance(token_ids, int):
            token_ids = [token_ids]
        text = self._tokenizer.decode(token_ids, skip_special_tokens=skip_special_tokens) #[] True
