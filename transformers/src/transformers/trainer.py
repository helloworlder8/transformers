...
class Trainer:
        ...
        **kwargs,
        ...
        if args.push_to_hub:
            ...
            return inner_training_loop(
                ...
                trial=trial, #none
                ignore_keys_for_eval=ignore_keys_for_eval, #none
            )
    ...
    def _inner_training_loop(
        ...
        self.accelerator.free_memory()
        self._train_batch_size = batch_size #16
        ...
        for epoch in range(epochs_trained, num_train_epochs):
            ...
            for _ in range(total_updates):
                ...
                for i, inputs in enumerate(batch_samples):
                    ...
                    with context():
                        tr_loss_step = self.training_step(model, inputs, num_items_in_batch) #最重点 前向传播
    ...
    def training_step( #最重点 前向传播
        ...
        with self.compute_loss_context_manager():
            loss = self.compute_loss(model, inputs, num_items_in_batch=num_items_in_batch) #前向传播
    ...
    def compute_loss(self, model, inputs, return_outputs=False, num_items_in_batch=None): #最重点，前向传播
        """
