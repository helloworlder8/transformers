...
class GroundingDinoModelTest(ModelTesterMixin, PipelineTesterMixin, unittest.TestCase):
    ...
    # overwrite since hidden_states are called enc_text_all_hidden_states
    def test_hidden_states_output(self):
        def check_hidden_states_output(inputs_dict, config, model_class):
            ...
            hidden_states = outputs.enc_vision_all_hidden_states
            ...
            hidden_states = outputs.enc_text_all_hidden_states
    ...
    def test_retain_grad_hidden_states_attentions(self):
        ...
        encoder_hidden_states = outputs.enc_vision_all_hidden_states[0]
